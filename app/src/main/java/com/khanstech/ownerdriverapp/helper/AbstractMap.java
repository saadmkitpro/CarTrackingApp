...
public class AbstractMap extends Activity {
    protected static final String TAG_ERROR_DIALOG_FRAGMENT = "error";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // startActivity(new Intent(this, ActivityLegalNotices.class));
        // return true;
        // }
    ...
    protected boolean readyToGo() {
        ...
        if (status == ConnectionResult.SUCCESS) {
            ...
            ErrorDialogFragment.newInstance(status).show(getFragmentManager(),
